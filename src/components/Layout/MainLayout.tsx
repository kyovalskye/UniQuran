    ...
    function handleScroll() {
      if (props.showScrollIndicator) {
        ...
        if (scrollHeight - clientHeight >= 1) {
          width =
            (window.scrollY /
              (scrollHeight - clientHeight - navbarHeight - 30)) *
            100;
        }
    ...
    return (
      <>
          ...
          <ul class="sidebar-menu">
            {SIDBAR_MENU.map((item, key) => (
              <li
                ...
                class={[
                  "menu-link",
                  { active: this.$route.name == item.route },
                ]}
              ...
              >
                <div>
                  ...
                  <div class="menu-link-text">{this.$t(item.label)}</div>
                </div>
              </li>
            ))}
          </ul>
              ...
              <div class="ps-1 pe-1">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  <div class="d-flex align-items-center h-100">
                    <div
                      class={["me-1", styles.nav_menu_item]}
                  ...
                  <div>
                    <div class="d-flex">
                      ...
                      >
                        <Tooltip title={this.$t("setting").toLocaleLowerCase()}>
                          <font-awesome-icon icon="gear" class={styles.icon} />
                        </Tooltip>
                      </div>
                      <div
                        class={["me-0", styles.nav_menu_item]}
                        onClick={() => (this.showSearchChapters = true)}
                      >
                        <Tooltip
                          title={this.$t(
                            "general.search-surah"
                          ).toLocaleLowerCase()}
                        >
                          <font-awesome-icon
                            icon="search"
                    ...
                    <div class="ps-2 pe-2">
                      <div
                        class={[
                          "progress h-5-px",
                          {
                            "position-fixed sticky-top top-0 start-0 w-100 border-radius-0 z-index-1090":
                              !this.fixed,
                          },
                        ]}
                      >
        ...
        <div class="main-content">
          <div class="container-fluid mt-5">{this.$slots.default?.()}</div>
        </div>
