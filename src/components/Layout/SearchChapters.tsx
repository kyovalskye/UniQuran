...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    function addFavorite(id: number) {
      if (isFavorite(id)) {
        ...
        storage.set(STORAGE_KEY, (favorite: Record<string, any> = {}) => {
          ...
          return {
            ...favorite,
            [id]: value.length ? Math.max(...value) + 1 : 1,
          };
        });
      }
    }
    ...
    function gotoChapter(id: number) {
      console.log("Navigating to chapter:", id); // Debugging
                ...
                <div class={["card", styles.card]}>
                  ...
                  <div class={["card-body custom-scrollbar", styles.card_body]}>
                    {!this.query.trim() ? (
                      ...
                      this.filteredChapters.map((item) => (
                        <div
                          key={item.id}
                          class={[
                            styles.chapter,
                        ...
                        >
                          <span
                            ...
                            onClick={(e) => {
                              ...
                              this.gotoChapter(item.id);
                            }}
                          >
                            {item.name_simple}
                          </span>
                          <Tooltip
                            title={this.$t("general.add-to-favorite")}
                          ...
                          >
                            <Button
                              ...
                              type={
                                this.isFavorite(item.id) ? "primary" : "default"
                              }
